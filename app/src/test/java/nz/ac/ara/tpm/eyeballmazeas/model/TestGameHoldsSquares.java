...
class TestGameHoldsSquares {
    ...
    void testColoursAreAsAdded() {
        ...
        Color[] expectedColors = { 
            Color.BLUE, Color.RED, Color.YELLOW, Color.GREEN, Color.BLANK, Color.PURPLE 
        };
        Color[] actualColors = { 
    ...
    void testShapesAreAsAdded() {
        ...
        Shape[] expectedShapes = { 
            Shape.DIAMOND, Shape.CROSS, Shape.STAR, Shape.FLOWER, Shape.BLANK, Shape.LIGHTNING 
        };
        Shape[] actualShapes = { 
            game.getShapeAt(2, 0), game.getShapeAt(3, 0), game.getShapeAt(4, 0),
